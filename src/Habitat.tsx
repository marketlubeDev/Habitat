...
{
title: "Rooms & Suites",
description: "Luxurious accommodations with modern amenities and serene views",
icon: "fa-bed",
image: "https://readdy.ai/api/search-image?query=Elegant%20hotel%20room%20with%20king%20size%20bed%2C%20large%20windows%20with%20nature%20view%2C%20wooden%20furniture%2C%20white%20linens%2C%20soft%20lighting%2C%20modern%20amenities%2C%20luxury%20resort%20style%2C%20peaceful%20atmosphere%2C%20neutral%20color%20palette&width=400&height=300&seq=4&orientation=landscape"
},
{
title: "Ayurvedic Spa",
description: "Traditional treatments and therapies for complete rejuvenation",
icon: "fa-spa",
image: "https://readdy.ai/api/search-image?query=Ayurvedic%20spa%20treatment%20room%20with%20wooden%20elements%2C%20massage%20table%20with%20white%20linens%2C%20essential%20oils%2C%20soft%20lighting%2C%20tropical%20plants%2C%20peaceful%20ambiance%2C%20luxury%20wellness%20retreat%20style%2C%20natural%20materials&width=400&height=300&seq=5&orientation=landscape"
},
{
title: "Banquet Hall",
description: "Elegant spaces for celebrations, meetings and special occasions",
icon: "fa-glass-cheers",
image: "https://readdy.ai/api/search-image?query=Elegant%20banquet%20hall%20with%20high%20ceilings%2C%20wooden%20flooring%2C%20large%20windows%2C%20sophisticated%20lighting%2C%20round%20tables%20with%20white%20linens%2C%20floral%20arrangements%2C%20luxury%20resort%20style%2C%20warm%20ambiance&width=400&height=300&seq=6&orientation=landscape"
},
{
title: "Swimming Pool",
description: "Refreshing infinity pool surrounded by tropical gardens",
icon: "fa-swimming-pool",
image: "https://readdy.ai/api/search-image?query=Luxury%20infinity%20pool%20overlooking%20lush%20green%20landscape%2C%20lounge%20chairs%20with%20white%20cushions%2C%20palm%20trees%2C%20clear%20blue%20water%2C%20wooden%20deck%2C%20resort%20umbrellas%2C%20peaceful%20atmosphere%2C%20sunset%20lighting&width=400&height=300&seq=7&orientation=landscape"
},
{
title: "Fitness Centre",
description: "State-of-the-art equipment and personalized training programs",
icon: "fa-dumbbell",
image: "https://readdy.ai/api/search-image?query=Modern%20fitness%20center%20with%20wooden%20flooring%2C%20large%20windows%20with%20nature%20view%2C%20high-end%20exercise%20equipment%2C%20mirrors%2C%20yoga%20mats%2C%20water%20station%2C%20towels%2C%20luxury%20resort%20style%2C%20clean%20and%20spacious&width=400&height=300&seq=8&orientation=landscape"
},
{
title: "Play Area",
description: "Fun activities for all ages in a safe and engaging environment",
icon: "fa-futbol",
image: "https://readdy.ai/api/search-image?query=Outdoor%20play%20area%20with%20wooden%20structures%2C%20green%20lawn%2C%20swings%2C%20slides%2C%20climbing%20frames%2C%20surrounded%20by%20tropical%20plants%2C%20shaded%20areas%2C%20benches%2C%20luxury%20resort%20style%2C%20family-friendly%20atmosphere&width=400&height=300&seq=9&orientation=landscape"
}
];
const amenities = [
...
<a href="#amenities" className="text-gray-700 hover:text-green-700 transition duration-300">Amenities</a>
<a href="#ayurveda" className="text-gray-700 hover:text-green-700 transition duration-300">Ayurveda</a>
<a href="#gallery" className="text-gray-700 hover:text-green-700 transition duration-300">Gallery</a>
<a href="#contact" className="px-6 py-2 bg-green-700 text-white rounded-button hover:bg-green-800 hover:scale-105 transform transition-all duration-300 shadow-md hover:shadow-lg">Contact</a>
</div>
<div className="md:hidden">
<button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-gray-700 focus:outline-none cursor-pointer">
...
<a href="#home" className="block py-2 text-gray-700 hover:text-green-700">Home</a>
<a href="#about" className="block py-2 text-gray-700 hover:text-green-700">About</a>
<a href="#services" className="block py-2 text-gray-700 hover:text-green-700">Services</a>
<a href="#amenities" className="block py-2 text-gray-700 hover:text-green-700">Amenities</a>
<a href="#ayurveda" className="block py-2 text-gray-700 hover:text-green-700">Ayurveda</a>
<a href="#gallery" className="block py-2 text-gray-700 hover:text-green-700">Gallery</a>
<a href="#contact" className="block py-2 text-gray-700 hover:text-green-700">Contact</a>
<button className="mt-2 bg-green-700 text-white px-6 py-2 rounded-button whitespace-nowrap hover:bg-green-800 transition duration-300 w-full cursor-pointer">Book Now</button>
</div>
)}
</div>
</nav>
...
<h2 className="text-3xl font-bold mb-6 text-green-800">About Focuz Habitat</h2>
<p className="text-gray-700 mb-6 leading-relaxed">
Nestled in the serene landscape of Malappuram, Kerala, Focuz Habitat is a premium health resort where luxury meets wellness. Our resort is designed to provide a perfect escape from the hustle and bustle of everyday life, allowing you to reconnect with nature and yourself.
</p>
<p className="text-gray-700 mb-6 leading-relaxed">
Founded on the principles of Ayurveda and holistic wellness, Focuz Habitat combines traditional healing practices with modern comforts to create a unique experience that rejuvenates your mind, body, and soul. Our expert team of practitioners and hospitality professionals ensure that every aspect of your stay contributes to your overall wellbeing.
</p>
<p className="text-gray-700 leading-relaxed">
Whether you're seeking a wellness retreat, a peaceful vacation, or a venue for your special event, Focuz Habitat offers the perfect blend of luxury, nature, and authentic Kerala hospitality.
</p>
</div>
...
<h2 className="text-3xl font-bold text-green-800 mb-4">Everything We Have</h2>
<p className="text-gray-600 max-w-2xl mx-auto">
Discover our comprehensive range of facilities and services designed to make your stay comfortable, rejuvenating, and memorable.
</p>
</div>
...
<i className={`fas ${service.icon} text-green-700 text-2xl mr-3`}></i>
<h3 className="text-xl font-semibold text-gray-800">{service.title}</h3>
</div>
<p className="text-gray-600 mb-4">{service.description}</p>
<a href="#" className="text-green-700 font-medium hover:text-green-800 transition duration-300 flex items-center cursor-pointer">
Learn More
...
<div className="container mx-auto px-6">
<div className="text-center mb-16">
<h2 className="text-3xl font-bold text-green-800 mb-4">Resort Amenities</h2>
<p className="text-gray-600 max-w-2xl mx-auto">
Enjoy our wide range of premium amenities designed to enhance your comfort and convenience during your stay.
</p>
</div>
...
style={{
backgroundImage: "url('https://readdy.ai/api/search-image?query=Ayurvedic%20spa%20setting%20with%20wooden%20elements%2C%20massage%20oils%2C%20fresh%20herbs%2C%20flowers%2C%20candles%2C%20soft%20lighting%2C%20natural%20materials%2C%20serene%20atmosphere%2C%20luxury%20wellness%20retreat%20style%2C%20traditional%20Kerala%20elements&width=1440&height=600&seq=11&orientation=landscape')",
...
<h2 className="text-3xl font-bold mb-6">Authentic Ayurvedic Experience</h2>
<p className="mb-6 leading-relaxed">
Immerse yourself in the ancient healing tradition of Ayurveda at our specialized wellness center. Our experienced practitioners offer personalized treatments designed to restore balance and promote holistic wellbeing.
</p>
...
<div className="container mx-auto px-6">
<div className="text-center mb-16">
<h2 className="text-3xl font-bold text-green-800 mb-4">Resort Gallery</h2>
<p className="text-gray-600 max-w-2xl mx-auto">
Take a visual journey through our beautiful resort and experience the luxury and serenity that awaits you.
</p>
</div>
...
<div className="container mx-auto px-6">
<div className="text-center mb-16">
<h2 className="text-4xl font-bold text-green-800 mb-4">Guest Experiences</h2>
<p className="text-gray-600 max-w-2xl mx-auto text-lg">
Discover what our esteemed guests have to say about their transformative journey at Focuz Habitat.
</p>
</div>
...
<div
id="testimonialTrack"
className={`flex space-x-8 py-8 transition-transform duration-500 ease-in-out ${!isAutoScrollPaused && !isDragging ? 'animate-scroll' : ''}`}
...
rating: 5,
text: "My stay at Focuz Habitat was truly transformative. The Ayurvedic treatments, serene environment, and attentive staff made this the perfect wellness retreat. I left feeling completely rejuvenated.",
image: "https://readdy.ai/api/search-image?query=professional%20headshot%20of%20a%20sophisticated%20woman%20in%20her%2040s%20with%20blonde%20hair%20wearing%20elegant%20business%20attire%20natural%20lighting%20neutral%20background%20confident%20smile&width=100&height=100&seq=19&orientation=squarish"
},
{
name: "Michael Chen",
location: "Singapore",
rating: 5,
text: "An oasis of tranquility with world-class amenities. The perfect balance of luxury and authenticity. The Ayurvedic treatments were exceptional and the staff's attention to detail was impressive.",
image: "https://readdy.ai/api/search-image?query=professional%20headshot%20of%20an%20asian%20businessman%20in%20his%2030s%20wearing%20modern%20suit%20natural%20lighting%20neutral%20background%20warm%20smile&width=100&height=100&seq=20&orientation=squarish"
},
{
name: "Priya Sharma",
location: "Mumbai, India",
rating: 5,
text: "Focuz Habitat exceeded all my expectations. The rooms are spacious and beautifully designed, the food is exquisite, and the spa treatments are truly rejuvenating. A hidden gem in Kerala!",
image: "https://readdy.ai/api/search-image?query=professional%20headshot%20of%20an%20indian%20woman%20in%20her%2030s%20wearing%20elegant%20traditional%20outfit%20natural%20lighting%20neutral%20background%20genuine%20smile&width=100&height=100&seq=21&orientation=squarish"
},
{
name: "James Anderson",
...
image: "https://readdy.ai/api/search-image?query=professional%20headshot%20of%20a%20distinguished%20man%20in%20his%2050s%20wearing%20luxury%20suit%20natural%20lighting%20neutral%20background%20confident%20expression&width=100&height=100&seq=22&orientation=squarish"
},
{
name: "Emma Thompson",
...
image: "https://readdy.ai/api/search-image?query=professional%20headshot%20of%20an%20australian%20woman%20in%20her%2030s%20wearing%20modern%20professional%20attire%20natural%20lighting%20neutral%20background%20bright%20smile&width=100&height=100&seq=23&orientation=squarish"
},
{
name: "Ahmed Al-Sayed",
location: "Dubai, UAE",
...
image: "https://readdy.ai/api/search-image?query=professional%20headshot%20of%20a%20middle%20eastern%20businessman%20in%20his%2040s%20wearing%20luxury%20suit%20natural%20lighting%20neutral%20background%20welcoming%20smile&width=100&height=100&seq=24&orientation=squarish"
}
...
<p className="text-gray-600 max-w-2xl mx-auto">
Have questions or ready to book your stay? Reach out to us and our team will be happy to assist you.
</p>
</div>
...
<p className="text-gray-600 text-sm mt-1">Focuz Habitat, Malappuram, Kerala, India</p>
</div>
</div>
</div>
<div className="transform hover:scale-105 transition-transform duration-300">
<a href="tel:+918592011120" className="flex items-center space-x-4 cursor-pointer">
<div className="w-12 h-12 bg-green-50 rounded-xl flex items-center justify-center">
<i className="fas fa-phone-alt text-green-600 text-xl"></i>
</div>
<div>
<h4 className="font-semibold text-gray-900">Call Us</h4>
<p className="text-gray-600 text-sm mt-1">+91 85920 11120</p>
</div>
</a>
</div>
<div className="transform hover:scale-105 transition-transform duration-300">
...
<p className="text-gray-600 text-sm mt-1">info@focuzhabitat.com</p>
</div>
</div>
</div>
<div className="transform hover:scale-105 transition-transform duration-300">
...
<p className="text-gray-600 text-sm mt-1">24/7 Customer Service</p>
</div>
</div>
</div>
</div>
...
<p className="text-gray-600 text-sm mt-1">Follow us on social media</p>
</div>
<div className="flex space-x-4">
<a href="#" className="w-10 h-10 bg-green-50 rounded-full flex items-center justify-center text-green-600 hover:bg-green-100 transition-colors duration-300">
...
A premium health resort nestled in the serene landscape of Malappuram, Kerala, offering a perfect blend of luxury, wellness, and authentic experiences.
</p>
<div className="flex space-x-4">
...
<li>
<a href="#home" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Home</a>
</li>
<li>
<a href="#about" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">About</a>
</li>
<li>
<a href="#amenities" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Amenities</a>
</li>
<li>
<a href="#ayurveda" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Ayurveda</a>
</li>
<li>
<a href="#gallery" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Gallery</a>
</li>
<li>
<a href="#contact" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Contact</a>
</li>
</ul>
</div>
<div>
...
<ul className="space-y-3">
<li>
<a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Rooms & Suites</a>
</li>
<li>
<a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Ayurvedic Spa</a>
</li>
<li>
<a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Banquet Hall</a>
</li>
<li>
<a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Swimming Pool</a>
</li>
<li>
<a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Fitness Centre</a>
</li>
<li>
<a href="#" className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Play Area</a>
</li>
</ul>
</div>
<div>
...
<p className="text-gray-400 mb-6">
Subscribe to our newsletter for special offers, wellness tips, and updates.
</p>
<form>
...
&copy; {new Date().getFullYear()} Focuz Habitat. All rights reserved. - made by <a href="https://www.marketlube.in" target="_blank" rel="noopener noreferrer" className="underline hover:text-white transition duration-300">marketlube</a>
</p>
<div className="flex space-x-6">
<a href="#" className="text-gray-400 hover:text-white text-sm transition duration-300 cursor-pointer">Privacy Policy</a>
<a href="#" className="text-gray-400 hover:text-white text-sm transition duration-300 cursor-pointer">Terms of Service</a>
<a href="#" className="text-gray-400 hover:text-white text-sm transition duration-300 cursor-pointer">Cookie Policy</a>
</div>
</div>
</div>
</footer>
