          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
              <div className="max-w-4xl mx-auto">
                <h1 className="font-poppins text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white mb-4 leading-none tracking-tight transform transition-all duration-700 hover:scale-105 whitespace-nowrap">
                  {slide.title}
                </h1>
      ...
      <section id="gallery" className="py-20">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="relative overflow-hidden rounded-lg shadow-lg h-64 sm:h-72 lg:h-80 cursor-pointer">
              <img
